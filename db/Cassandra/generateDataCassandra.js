...
const writeStreamProduct = fs.createWriteStream("./cassandraData-product.csv");
const writeStreamVersions = fs.createWriteStream("./cassandraData-version.csv");
const writeStreamNewVersion = fs.createWriteStream("./cassandraData-new.csv");
const writeStreamOldVersion = fs.createWriteStream("./cassandraData-old.csv");

let productColumns = ['partition_id', 'clustering_id', 'name', 'description', 'seller', 'prime_eligible', 'versions', 'image_urls', 'expected_date_of_arrival', 'five_star_reviews', 'four_star_reviews', 'three_star_reviews', 'two_star_reviews', 'one_star_reviews', 'answered+questions'];
let versionsColumns = ['partition_id', 'clustering_id', 'newId', 'oldId'];
let oldVersionColumns = ['partition_id', 'clustering_id', 'qty_in_stock', 'price'];
let newVersionColumns = ['partition_id', 'clustering_id', 'qty_in_stock', 'price'];
